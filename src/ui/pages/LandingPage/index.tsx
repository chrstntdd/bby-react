...
const navigationButtons =
  'z-10 font-semibold rounded-full px-8 py-2 leading-normal bg-transparent border border-grey text-grey hover:border-bby-blue hover:bg-bby-blue hover:text-white m-6 trans-300ms-all';

const howCard = {
  container: 'flex flex-col items-center justify-center m-8 bg-grey rounded how-card-cont',
  title: 'text-center grey',
  subtext: 'text-center',
  svg: 'h-64 w-32 ofc'
};

const footer = {
  links: 'no-underline text-white font-semibold hover:underline'
};
  ...
  <div>
    <section className="h-screen w-screen text-black">
      ...
      <div className="kinda-center z-10 w-full">
        <h1 className="text-white italic text-center leading-none whitespace-no-wrap text-5xl md:text-massive tracking-wide mb-2">
          Quantified
        </h1>
        <h2 className="text-white italic text-center leading-none text-2xl font-thin">
          A streamlined system for efficiently and accurately managing retail inventory.
        </h2>
      </div>
    </section>
    <section id="how-section" className="bg-bby-blue">
      <h2 className="text-4xl pt-6 text-white text-center">features</h2>
      <div className="card-container flex flex-wrap justify-center lp-max-width m-auto">
        <div className={howCard.container}>
          ...
          <h3 className={howCard.title}>Simple</h3>
          <p className={howCard.subtext}>and powerful</p>
        </div>
        <div className={howCard.container}>
          <svg viewBox="0 0 100 100" width="100%" height="100%" fill="#000">
            <path d="M73.76 31.69l10.73 20.42s-1.18 2.62-3.95 5.6c-2.01 2.15-4.62 4.02-4.62 4.02L56.17 39.82s-.82-.9-2.16-1.05c-.99-.1-2.83.6-2.83.6L40 45.47s-2.61 1.83-4.47-.81c-1.8-2.53 1.41-4.77 1.41-4.77S47 31.62 53.64 28.56c3.3-1.52 6.33-.97 8.42.15s5.44 3.47 7.08 4.1c1.93.74 4.62-1.12 4.62-1.12zm20.59 16.6L82.52 26.22a1.2 1.2 0 0 0-1.62-.48l-4.57 2.41a1.2 1.2 0 0 0-.49 1.62l11.84 22.06c.31.58 1.03.8 1.61.5l4.58-2.43c.58-.3.8-1.03.48-1.61zm-4.57.28a1.67 1.67 0 1 1 0-3.35 1.67 1.67 0 0 1 0 3.35z" />
            <path d="M26.31 60.46c-.07-.04-1.8-.99-4.82-3.71a30.55 30.55 0 0 1-3.76-4.48 1.2 1.2 0 0 1-.07-1.24l10.63-19.98a1.2 1.2 0 0 1 1.48-.55s.57.21 1.88.47c1.35.25 2.39-.05 4.11-.56l1.08-.31c1-.29 2.05-.87 3.16-1.49 1.3-.73 2.66-1.49 4.17-1.88a5.36 5.36 0 0 1 5.4 1.68l-1.85 1.5a2.99 2.99 0 0 0-2.95-.87c-1.22.32-2.43 1-3.61 1.65-1.18.66-2.4 1.34-3.67 1.7l-1.05.3c-1.86.55-3.32.99-5.24.62-.51-.1-.93-.2-1.26-.28L20.1 51.5c.63.86 1.87 2.48 2.97 3.47 2.82 2.54 4.36 3.39 4.37 3.4l-1.14 2.1zM59 78.5a4.13 4.13 0 0 1-2.64-.99l.8-.88.8-.9c.3.27 1.44 1 2.97-.77 1.56-1.82.36-3.7.35-3.71l2-1.31a5.53 5.53 0 0 1-.54 6.57c-1.06 1.23-2.24 1.9-3.5 1.97l-.24.01z" />
            <path d="M66.15 73.6a6.12 6.12 0 0 1-2.58-.66c-1.13-.52-2.87-2.36-3.2-2.73a1.2 1.2 0 0 1 1.74-1.62c.82.89 2 1.97 2.46 2.19 1.08.5 2.07.81 3.3-.37 1.5-1.46.2-3.42-.02-3.75l-6.88-7.32a1.2 1.2 0 1 1 1.73-1.64l6.93 7.38.09.1c1.02 1.35 2.29 4.53-.2 6.94a4.74 4.74 0 0 1-3.37 1.49z" />
            <path d="M73.4 69.65a5.74 5.74 0 0 1-3.82-1.47l-3.66-3.6 1.67-1.7 3.65 3.58c.17.15 1.84 1.6 4.08.21.93-.57 1.5-1.2 1.64-1.83.14-.62-.16-1.1-.17-1.11l1.97-1.34c.1.13.87 1.3.54 2.9-.27 1.32-1.2 2.46-2.73 3.41-1.11.7-2.19.95-3.16.95zm-41.1-4.32a3.1 3.1 0 0 1-4.38-4.37l1.47-1.48a3.1 3.1 0 1 1 4.37 4.37l-1.47 1.48zm6.03 4.97a3.1 3.1 0 0 1-4.37-4.37l4.84-4.85a3.1 3.1 0 1 1 4.37 4.37l-4.84 4.85zm6.93 4.72a3.1 3.1 0 0 1-4.37-4.38l6.15-6.15a3.1 3.1 0 0 1 4.37 4.38l-6.15 6.15zM52.44 79a3.1 3.1 0 1 1-4.38-4.37l3.21-3.22a3.1 3.1 0 0 1 4.37 4.37L52.45 79z" />
            <circle r="1.68" cy="47.15" cx="11.15" />
            <path d="M19.22 27.35c.2 0 .39.05.57.14l2.92 1.65c.58.3.8 1.03.49 1.61L12.96 50.14a1.2 1.2 0 0 1-1.61.48l-2.92-1.64a1.2 1.2 0 0 1-.49-1.62l10.23-19.38c.22-.4.63-.63 1.05-.63m0-2.38c-1.32 0-2.52.72-3.15 1.88v.02L5.83 46.24a3.56 3.56 0 0 0 1.43 4.82l2.91 1.64.02.01.02.01a3.57 3.57 0 0 0 4.85-1.45v-.02L25.3 31.87a3.58 3.58 0 0 0-1.43-4.82l-2.92-1.64h-.01l-.02-.02a3.6 3.6 0 0 0-1.7-.42zm43.36 47.01c-.32 0-.64-.12-.87-.37l-6.93-7.38a1.2 1.2 0 0 1 1.74-1.63l6.93 7.38a1.19 1.19 0 0 1-.87 2z" />
          </svg>

          <h3 className={howCard.title}>Reliable</h3>
          <p className={howCard.subtext}>there when you need it</p>
        </div>
        <div className={howCard.container}>
          <svg viewBox="0 0 100 100" width="100%" height="100%" fill="#000">
          ...
          <h3 className={howCard.title}>Safe</h3>
          <p className={howCard.subtext}>without compromises</p>
        </div>
        <div className={howCard.container}>
          <svg viewBox="0 0 100 100" width="100%" height="100%">
          ...
          <h3 className={howCard.title}>Fast</h3>
          <p className={howCard.subtext}>designed for speed</p>
        </div>
      </div>
    </section>
    ...
    <footer className="bg-bby-blue">
      <ul className="flex flex-col justify-center items-center list-reset no-underline">
        <li className="py-3">
          <Link className={footer.links} to="/sign-up">
            Start here
          </Link>
        </li>

        <li className="py-3">
          <Link className={footer.links} to="/sign-in">
            Sign in
          </Link>
        </li>
        ...
        <li className="py-3">
          <a
            ...
            href="https://developer.bestbuy.com/api-status"
            target="_blank"
          >
        ...
        <li className="py-3">
          <a className={footer.links} href="https://github.com/chrstntdd" target="_blank">
